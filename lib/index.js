import { A as WorkBuddyUpstreamClient, C as defaultDesktopAuthDirs, D as parseWorkBuddyAuth, E as isFresher, F as parseUpstreamTask, I as prepareChatBody, L as regionOf, M as parseCreditMultiplier, N as parseReasoning, O as workbuddyAccountId, P as parseUpstreamModel, R as selectCliModels, S as defaultDesktopAuthCandidates, T as expiryToMs, _ as deriveCatalog, a as readHostHeartbeat, b as WorkBuddyCredentialStore, c as WORKBUDDY2API_VERSION, d as nextDay4Am, f as stickyKeyOf, g as applyContextBudgets, h as WorkBuddyCatalog, i as processStartTimeMs, j as classifyUpstreamError, k as workbuddyOwnAuthPath, l as DEFAULT_WORKBUDDY_POOL_POLICY, m as FALLBACK_WORKBUDDY_MODELS_GLOBAL, n as clearHostHeartbeat, o as workbuddyHostHeartbeatPath, p as FALLBACK_WORKBUDDY_MODELS, r as isHeartbeatProcessAlive, s as writeHostHeartbeat, t as WORKBUDDY2API_HOST_HEARTBEAT_FILENAME, u as WorkBuddyAccountPool, v as fallbackModelsFor, w as defaultDesktopAuthPath, x as authFileName, y as WORKBUDDY_AUTH_FILE_ENV } from "./host-heartbeat-DkDnDaDc.js";
	...
	*/
	async run(credential, options = {}) {
		...
		for (const action of ACTIONS) {
			...
			try {
				item.message = await action.run(this.options.client, credential);
			} catch (error) {
				results.push({
					...item,
					outcome: "error",
